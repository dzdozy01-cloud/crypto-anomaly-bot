...
**Scoring latency p95 ≈ 65 ms**, well inside the 200 ms budget. 300 tests passing.
...
| `/watchlist` | Tokens discovery flagged, ranked by move, with live OBI |
...
```bash
pytest tests/ -v                                  # 300 tests, ~2 min
